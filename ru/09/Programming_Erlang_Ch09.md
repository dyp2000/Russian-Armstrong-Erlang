...
![image](http://https://github.com/dyp2000/Russian-Armstrong-Erlang/blob/master/ru/09/img-9.1.png)
...
Дополнительно процесс Pid1 может послать сигнал выхода X процессу Pid2, выполнив функцию exit(Pid2, X). Процесс, который посылает сигнал выхода
